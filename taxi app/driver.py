...
class Driver:
    ...
    _destination: The destination of the driver. None if the driver has no
     destination
        and is idle.
    _passenger: The current passenger for the driver, or None if the driver
     is not
    ...
    def __str__(self) -> str:
        ...
        """
        return "driver" + str(self.id) + "has the speed" + str(self._speed)
    ...
    def get_travel_time(self, destination: Location) -> int:
        ...
        """
        x = manhattan_distance(self.location, destination)
        return round(x // self._speed)
    ...
    def start_drive(self, location: Location) -> int:
        ...
        self.is_idle = False
        y = self.get_travel_time(location)
        return y
    ...
    def start_trip(self, passenger: Passenger) -> int:
        ...
        y = self.get_travel_time(passenger.destination)
        return y
