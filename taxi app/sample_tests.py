...
def test_location_print() -> None:
    """ Tests for the correct implementation of the creating and print of the Location class
    """
...
def test_event_creation() -> None:
    ...
    for event in events:
        instance = isinstance(event, PassengerRequest) or isinstance(event, DriverRequest)
...
def test_simulation_run() -> None:
    ...
    assert report['average_driver_trip_distance'] == pytest.approx(3.8333333333333335)
